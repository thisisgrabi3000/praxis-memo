...
powershell -NoProfile -Command ^
  "Compress-Archive -Force -Path 'index.html','styles.css','app.js','praxis_memo_server.py','Start Praxis Memo.bat','KI einrichten.bat','Datenordner oeffnen.bat','README_PC_INSTALLATION.txt' -DestinationPath '%ZIPNAME%'"
